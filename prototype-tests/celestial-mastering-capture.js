...
async function shot(state){await page.$eval(rain,e=>e.scrollIntoView({block:'start'}));await sleep(200);const el=await page.$(rain);await el.screenshot({path:`${out}/${state}-${key}.png`});}
